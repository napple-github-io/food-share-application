...
function getListingMap(address, addresses) {
  const url = `https://maps.googleapis.com/maps/api/staticmap?center=${address}&markers=color:blue|${addresses}&size=400x400&key=${process.env.API_KEY}`;
  return url;
}
